...
public class PrimaryDirectionsCalculator {

    private static final Logger LOG = Logger.getLogger(PrimaryDirectionsCalculator.class);
    public static final int MAX_YEARS_DURATION = 130;

    private PrimaryDirectionsCalculator() {
    }

    private static class PrimaryDirectionsCalculatorHolder {
        private final static PrimaryDirectionsCalculator instance = new PrimaryDirectionsCalculator();
    }

    public static PrimaryDirectionsCalculator getInstance() {
        return PrimaryDirectionsCalculatorHolder.instance;
    }
    ...
    SortedSet<PrimaryDirection> generatePotentialDirections(SkyPosition skyPosition, Set<PotentialDirection> potentialDirections) {
    ...
    private DateTime getTimeForDirectedAscendant2(Degree degree,
        ...
        SwissEph swissEph = Swieph.getInstance().value();
